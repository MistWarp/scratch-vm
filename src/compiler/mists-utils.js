...
const mistsUtils = Object.freeze({
    ...
    round: c('number', ({input: i}) => `((a, b) => Math.round(a / b) * b)(${i.number('A')}, ${i.number('B')})`),
    ...
    interpolate: c('number', ({input: i}) =>
        `((a, b, c) => b + ((c - b) / a))(${i.number('A')}, ${i.number('B')}, ${i.number('C')})`),
    ifthen: c('string', ({input: i}) => `(${i.boolean('A')} ? ${i.string('B')} : ${i.string('C')})`),
    letters: c('string', ({input: i}) =>
        `((a, b, c) => c.substring(Math.max(0, a - 1), Math.min(b, c.length)))` +
        `(${i.number('A')}, ${i.number('B')}, ${i.string('C')})`),
    ...
    alltextAfterString: c('string', ({input: i}) =>
        `((a, b) => a.substring(a.indexOf(b) + 1))(${i.string('A')}, ${i.string('B')})`),
    ...
    isnumber: c('boolean', ({input: i}) => `(a => Number(a) == a)(${i.string('A')})`),
    isstring: c('boolean', ({input: i}) => `(a => String(a) == a)(${i.string('A')})`),
    isboolean: c('boolean', ({input: i}) => `(a => a == "true" || a == "false")(${i.string('A')})`),
    tostring: c('string', ({input: i}) => i.string('A')),
    tonumber: c('number', ({input: i}) => `(a => (isNaN(a) ? 0 : a))(Number(${i.string('A')}))`),
    toboolean: c('boolean', ({input: i}) =>
        `(a => a == "true" || a == "1" || a == "yes")(${i.string('A')})`),
    true: c('boolean', () => 'true'),
